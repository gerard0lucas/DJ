    ...
    t && Object.deepExtend(i, t), i.tmp.obj = {
        ...
        switch (i.canvas.ctx.fillStyle = n, i.canvas.ctx.beginPath(), e.shape) {
            ...
            case "image2":
                ...
                (c = document.createElement("img")).src = "assets/img/theme-img/ball_2.png", (r = c) && t();
                break;
            case "image3":
                if ("svg" == i.tmp.img_type) r = e.img.obj;
                else r = i.tmp.img_obj;
                (c = document.createElement("img")).src = "assets/img/theme-img/ball_3.png", (r = c) && t();
                break;
            case "image4":
                if ("svg" == i.tmp.img_type) r = e.img.obj;
                else r = i.tmp.img_obj;
                var c;
                (c = document.createElement("img")).src = "assets/img/theme-img/ball_4.png", (r = c) && t()
        }
        ...
        for (var e = 0; e < i.particles.array.length; e++) {
            ...
            switch (t.x - t.radius > i.canvas.w ? (t.x = s.x_left, t.y = Math.random() * i.canvas.h) : t.x + t.radius < 0 && (t.x = s.x_right, t.y = Math.random() * i.canvas.h), t.y - t.radius > i.canvas.h ? (t.y = s.y_top, t.x = Math.random() * i.canvas.w) : t.y + t.radius < 0 && (t.y = s.y_bottom, t.x = Math.random() * i.canvas.w), i.particles.move.out_mode) {
                case "bounce":
                    (t.x + t.radius > i.canvas.w || t.x - t.radius < 0) && (t.vx = -t.vx), (t.y + t.radius > i.canvas.h || t.y - t.radius < 0) && (t.vy = -t.vy)
            }
            ...
            if (i.tmp.repulse_finish || (i.tmp.repulse_count++, i.tmp.repulse_count == i.particles.array.length && (i.tmp.repulse_finish = !0)), i.tmp.repulse_clicking) {
                ...
                p <= o && function() {
                    ...
                    if (e.vx = m * Math.cos(t), e.vy = m * Math.sin(t), "bounce" == i.particles.move.out_mode) {
                        ...
                        (a.x + e.radius > i.canvas.w || a.x - e.radius < 0) && (e.vx = -e.vx), (a.y + e.radius > i.canvas.h || a.y - e.radius < 0) && (e.vy = -e.vy)
                    }
                }()
...
Object.deepExtend = function(e, t) {
    ...
    if (i.length)
        for (; i.length > 0;) a.removeChild(i[0]);
    var s = document.createElement("canvas");
    s.className = "particles-js-canvas-el", s.style.width = "100%", s.style.height = "100%", null != document.getElementById(e).appendChild(s) && pJSDom.push(new pJS(e, t))
