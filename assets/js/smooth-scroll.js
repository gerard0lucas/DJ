! function() {
    ...
    function m() {
        if (!c && document.body) {
            ...
            var n = document.body,
                ...
                u = n.scrollHeight;
            if (s = document.compatMode.indexOf("CSS") >= 0 ? r : n, e = n, a.keyboardSupport && X("keydown", b), top != self) l = !0;
            else if (J && u > i && (n.offsetHeight <= i || r.offsetHeight <= i)) {
                var d, f = document.createElement("div");
                if (f.style.cssText = "position:absolute; z-index:-10000; top:0; left:0; right:0; height:" + s.scrollHeight + "px", document.body.appendChild(f), o = function() {
                        d || (d = setTimeout((function() {
                            f.style.height = "0", f.style.height = s.scrollHeight + "px", d = null
                        }), 500))
                    }, setTimeout(o, 10), X("resize", o), (t = new j(o)).observe(n, {
                        attributes: !0,
                        childList: !0,
                        characterData: !1
                    }), s.offsetHeight <= i) {
    ...
    function p(e, t, o) {
        var n, r;
        if (n = (n = t) > 0 ? 1 : -1, r = (r = o) > 0 ? 1 : -1, (i.x !== n || i.y !== r) && (i.x = n, i.y = r, h = [], v = 0), 1 != a.accelerationMax) {
            var l = Date.now() - v;
            ...
            var d = function(n) {
                for (var r = Date.now(), l = 0, i = 0, c = 0; c < h.length; c++) {
                    ...
                    var p = s.x * v - s.lastX >> 0,
                        y = s.y * v - s.lastY >> 0;
                    l += p, i += y, s.lastX += p, s.lastY += y, m && (h.splice(c, 1), c--)
                }
                u ? window.scrollBy(l, i) : (l && (e.scrollLeft += l), i && (e.scrollTop += i)), t || o || (h = []), h.length ? $(d, e, 1e3 / a.frameRate + 1) : (w = !1, null != e.$scrollBehavior && (e.style.scrollBehavior = e.$scrollBehavior, e.$scrollBehavior = null))
            };
            $(d, e, 0), w = !0
        }
    }
    ...
    function y(t) {
        ...
        d && (t.wheelDeltaX && N(t.wheelDeltaX, 120) && (r = t.wheelDeltaX / Math.abs(t.wheelDeltaX) * -120), t.wheelDeltaY && N(t.wheelDeltaY, 120) && (i = t.wheelDeltaY / Math.abs(t.wheelDeltaY) * -120)), r || i || (i = -t.wheelDelta || 0), 1 === t.deltaMode && (r *= 40, i *= 40);
        var s = H(o);
        return s ? !! function(e) {
            if (e) {
                u.length || (u = [e, e, e]), e = Math.abs(e), u.push(e), u.shift(), clearTimeout(n), n = setTimeout((function() {
                    try {
        ...
        }(i) || (Math.abs(r) > 1.2 && (r *= a.stepSize / 120), Math.abs(i) > 1.2 && (i *= a.stepSize / 120), p(s, r, i), t.preventDefault(), void T()) : !l || !_ || (Object.defineProperty(t, "target", {
    ...
    function b(t) {
        var o = t.target,
            n = t.ctrlKey || t.altKey || t.metaKey || t.shiftKey && 32 !== t.keyCode;
        document.body.contains(e) || (e = document.activeElement);
        var r = /^(button|submit|radio|checkbox|file|color|image)$/i;
        if (t.defaultPrevented || /^(textarea|select|embed|object)$/i.test(o.nodeName) || A(o, "input") && !r.test(o.type) || A(e, "video") || function(e) {
                var t = e.target,
                    o = !1;
    ...
    var P, $ = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(e, t, o) {
            window.setTimeout(e, o || 1e3 / 60)
        },
        j = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver,
        R = (P = document.scrollingElement, function() {
            if (!P) {
    ...
    te && Q && (X(te, y, ee), X("mousedown", g), X("load", m)), oe.destroy = function() {
        t && t.disconnect(), Y(te, y), Y("mousedown", g), Y("keydown", b), Y("resize", o), Y("load", m)
